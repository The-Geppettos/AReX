...
const main = async () => {
  ...
  container.httpServer.get("/api/book/:id", async (req, res) => {
    try {
  ...
  container.httpServer.put("/api/book/:id/publish", async (req, res) => {
    const { id } = req.params;
    try {
  ...
  container.httpServer.put("/api/book/:id/unpublish", async (req, res) => {
    const { id } = req.params;
    try {
  ...
  container.httpServer.get("/api/book/:id/page/:page", async (req, res) => {
  ...
  container.httpServer.post("/api/agent/character/check", async (req, res) => {
    try {
  ...
  container.httpServer.post("/api/book_upload/book", async (req, res) => {
    try {
  ...
  container.httpServer.post("/api/book_upload/chapter", async (req, res) => {
  ...
  container.httpServer.post("/api/book_upload/page", async (req, res) => {
  ...
  container.httpServer.post("/api/book_upload/finish/:id", async (req, res) => {
    try {
      const { id } = req.params;
